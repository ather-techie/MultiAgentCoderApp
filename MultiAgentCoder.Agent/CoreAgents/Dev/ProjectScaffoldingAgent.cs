...
public sealed class ProjectScaffoldingAgent : BaseScaffholdingAgent, IProjectScaffoldingAgent
{
    ...
    public async Task<CodeArtifact> EnsureBuildable(ProjectSpec projectContext, CodeArtifact artifact)
    {
    ...
    private bool HasCsproj(ProjectSpec projectContext, CodeArtifact artifact)
    {
       return base.HasCsproj(projectContext, artifact,"*.Code.csproj",_ => true);
    }

    private CodeArtifact CreateDefaultCsproj(ProjectSpec projectContext, CodeArtifact artifact)
    {
...
""";
    ...
    private bool HasProgramCs(ProjectSpec projectContext, CodeArtifact artifact)
    {
